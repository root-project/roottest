...
int execTestMultiMerge()
{
   ...
   if (!result) result = testSimpleFile("hsimple209.root",25000,209,394062,8);
   if (!result) result = testSimpleFile("hsimpleK.root",5*25000,209,1917384,8);
   if (!result) result = testSimpleFile("hsimpleK202.root",5*25000,202,1938722,16);
